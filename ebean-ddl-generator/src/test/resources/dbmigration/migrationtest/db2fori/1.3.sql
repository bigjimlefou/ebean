...
alter table migtest_ckey_detail drop constraint if exists fk_mgtst_ck_e1qkb5;
...
alter table migtest_fk_none drop constraint if exists fk_mgtst_fk_nn_n_d;
alter table migtest_fk_none_via_join drop constraint if exists fk_mgtst_fk_9tknzj;
...
alter table migtest_e_basic drop constraint if exists fk_mgtst__bsc_sr_d;
...
alter table migtest_e_basic add constraint uq_mgtst__b_4aybzy unique  (indextest2);
alter table migtest_e_basic add constraint uq_mgtst__b_4ayc02 unique  (indextest6);
...
drop index if exists ix_mgtst__b_eu8css;
drop index if exists ix_mgtst__b_eu8csv;
